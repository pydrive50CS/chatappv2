...
import 'package:web_socket/presentation/screens/test.dart';
              ...
              child: Row(
                children: <Widget>[
                  ...
                  _isTextMessageComposing
                      ? const SizedBox()
                      : IconButton(
                          onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (context) => const AudioTest())), icon: const Icon(Icons.mic)),
